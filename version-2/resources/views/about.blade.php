...
<div class="relative z-0 w-full h-screen">
    <div class="lg:grid grid-cols-2 w-full flex justify-between leading-snug items-center">
        ...
        <div class="my-auto mt-24 w-full">
            ...
            <p class="paragraph">
                Team Piccolo is an Software Solutions, I.C.T Training solution and Academic Writing provider in Nigeria and Africa, with major projects realized in different parts of the country.
            </p>
            <p class="paragraph">
            ...
            <p class="paragraph">
                We aim to be our customers first choice in every area we serve by exceeding commitments, providing new technology solutions, leveraging our diverse brands, driving operational excellence, and committing to the highest standards of business practices all of which will drive Team Piccolo Global Enterprises long-term growth, value and success
            </p>
        </div>
    </div>
</div>
