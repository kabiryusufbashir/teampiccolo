            ...
            <div class="md:grid md:grid-cols-4 md:gap-4">
                <div class="col-span-4 bg-white mx-2 p-3">
                    <div class="flex justify-end">
                        <a href="{{ route('weeklyletter.create') }}">
                            ...
                            @foreach($weeklyletters as $weeklyletter)
                                <div class="card">
                                    ...
                                    <div class="btn-layout-control">
                                        <form action="{{ route('weeklyletter.show', $weeklyletter->id) }}">
                                        ...
                                        &nbsp;
                                        <form action="{{ route('weeklyletter.edit', $weeklyletter->id) }}" >
                                            @csrf 
                                        ...
                                        &nbsp;
                                        <form action="{{ route('weeklyletter.delete', $weeklyletter->id) }}" method="POST">
                                            @csrf 
                                            @method('DELETE')
