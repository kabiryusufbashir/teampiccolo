                            ...
                            @foreach($records as $record)
                                <div class="card">
                                    <div class="font-medium text-xl py-1">
                                        <span class="border-b-4">{!! html_entity_decode($record->transaction_details) !!}</span>
                                        <span class="font-normal text-sm">Amount: {{ $record->amount }}</span> <br>
                                    </div>
                                    <div class="btn-layout-control">
                                        <a class="-mt-4" href="{{ route('record.show', $record->id) }}">
                                        ...
                                        &nbsp;
                                        <form action="{{ route('record.edit', $record->id) }}" >
                                            @csrf 
