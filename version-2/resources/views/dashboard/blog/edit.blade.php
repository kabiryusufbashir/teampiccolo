                ...
                <div class="col-span-4 bg-white p-3">
                    ...
                    <div class="lg:w-3/4 mx-auto">
                        ...
                        @method('PATCH')
                            ...
                            <div class="my-2">
                                <textarea id="content" name="content" class="px-5 w-full border border-gray-400 h-24 rounded-lg my-2 text-lg focus:outline-none @error('content') border-red-500 @enderror">{{ $blog->content }}</textarea>
                                @error('content')
                                    {{$message}}
                                @enderror
                            </div>
