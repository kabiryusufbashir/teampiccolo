...
@section('body-content')
    <!-- Blog  -->
    @if($blogs->count())
        <div class="lg:grid grid-cols-3 gap-8 lg:mx-32 px-4 my-6 relative top-10 my-24">
            @foreach($blogs as $blog)
                <div class="shadow-lg p-6">
                    ...
                    <p class="paragraph">
                        ...
                        {!! html_entity_decode(Str::limit($blog->content, 150, '...')) !!} <a class="text-blue-600" href="#">Read more</a><br>
                        <b>By {{ \App\Models\Admin::where(['id' => $blog->author])->first()->name }}</b>
                    </p>
                </div>
            @endforeach
        </div>
