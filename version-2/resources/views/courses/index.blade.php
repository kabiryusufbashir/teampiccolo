...
@section('header')
<div class="relative z-0 w-full lg:h-screen">
    <div class="lg:grid grid-cols-2 w-full flex justify-between leading-snug items-center">
        <div class="hidden lg:block text-center bg-green-600 relative shadow-lg">
            <img class="w-full object-cover mx-auto w-full" src="{{ asset('images/about.jpg') }}" alt="About Us">
        </div>
