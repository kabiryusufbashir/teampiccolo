...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="hidden md:block z-50 sticky inset-x-0 top-0 left-0 py-5">
            <div class="absolute top-0 right-0">
                <a href="{{ route('login') }}" class="text-gray-900 flex">
        ...
        <div class="bg-gray-100">
            <div class="md:mx-32 px-4 py-6 text-gray-800">
                <div class="md:grid grid-cols-5 gap-6 py-4">
                    <div class="col-span-2 md:w-2/3">
                        <span class="text-2xl font-medium border-b-4 border-green-600">Team Piccolo</span>
                        <img class="w-32 my-4 pt-4" src="{{ asset('images/logo.png') }}" alt="Team Piccolo Logo">
                        <p class="text-lg py-8">Have an Idea you want to develop? <br>Contact us now for your Best I.C.T Training and Software solutions</p>
                    </div>
                    <div class="col-span-2">
                        <span class="text-2xl font-medium border-b-4 border-green-600">Navigation links</span>
                        <nav class="list-none text-gray-900 mt-4">
                            <li>
                    ...
                    <!-- <div class="col-span-2 my-auto">
                        ...
                        <form action="{{ route('news-letter') }}" class="text-black flex items-center" method="POST">
                            ...
                            <button class="bg-green-500 py-2 px-4 text-gray-900 rounded-tr-lg rounded-br-lg uppercase h-14 focus:outline-none" type="submit">Subscribe</button>
                        </form>
                    </div> -->
                </div>
            </div>
        </div>
        <div class="w-full py-8 text-center text-white text-sm bg-green-600">
            Copyright &copy; 2014-@php echo date('Y') @endphp  Team Piccolo All Rights Reserved
        </div>
