...
@section('page-title')
    Computer Application Blog | Team Piccolo
@endsection
...
@section('body-content')
    ...
    <div class="md:flex justify-center list-none mx-2 text-lg text-center">
        <li class="mx-4 text-green-600 hover:underline"><a href="{{ route('web.development') }}">Web Development</a></li>
        <li class="mx-4 text-green-600 hover:underline"><a href="{{ route('mobile.development') }}">Mobile Development</a></li>
        <li class="mx-4 text-green-600 hover:underline"><a href="{{ route('computer.application') }}">Computer Application</a></li>
