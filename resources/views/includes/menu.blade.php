...
<div id="menu" class="hidden md:block px-3 bg-white col-span-1 shadow-lg">
    ...
    <ul>
        ...
        <!-- Financial Records -->
        <li id="recordsCaret" class="py-3 flex border-b border-t cursor-pointer">
            <img class="w-7 mr-4" src="{{ asset('images/sales_icon.png') }}" alt="Financial Records">
            <a href="{{ route('record.index') }}">Financial Records</a>
            <svg id="recordsPointer" class="users-caret" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 15.707a1 1 0 010-1.414L14.586 10l-4.293-4.293a1 1 0 111.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z" clip-rule="evenodd"></path><path fill-rule="evenodd" d="M4.293 15.707a1 1 0 010-1.414L8.586 10 4.293 5.707a1 1 0 011.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
        </li>
        <div id="recordsMenu" class="users-caret-menu hidden">
            <li class="py-3 flex border-b">
                <a href="{{ route('record.create') }}">Add Record</a>
            </li>
            <li class="py-3 flex">
                <a href="{{ route('record.index') }}">All Record</a>
            </li>
        </div>
        ...
        <li id="newsletterCaret" class="py-3 flex border-b border-t cursor-pointer">
            ...
            <a href="{{ route('weeklyletter.index') }}">Weekly Letter</a>
        ...
        <div id="newsletterMenu" class="users-caret-menu hidden">
            <li class="py-3 flex border-b">
                <a href="{{ route('weeklyletter.create') }}">Add Weekly Letter</a>
            </li>
            <li class="py-3 flex">
                <a href="{{ route('weeklyletter.index') }}">All Weekly Letters</a>
            </li>
        </div>
